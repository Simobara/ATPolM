...
const FormGiurModalDel = ({ show, close }) => {
    // const [show, setShow] = useState(false);
    // const handleClose = () => setShow(false);
    // const handleShow = () => setShow(true);

    const handleConfirm = () => {
        alert("forma giuridica cancel");
        close();
    }
            ...
            >
                ...
                <Modal.Body>
                    <Row className="d-flex justify-content-start mb-4">
                        <h4>Sei sicuro di voler eliminare questa forma giuridica?</h4>
                        {/* <Col xs={12} md={6}>
...
export default FormGiurModalDel;