      ...
      >
        ...
        <Modal.Body>
          <Row style={{ width: "100%" }}>
            <Col sm={12} className="mb-4">
              <Row>
                ...
                <Col xs={12} md={6}>
                  <Form.Control type="text" placeholder="" autoFocus value={formData?.descrizione} name="descrizione" onChange={handleInputChange} style={{ border: "1px solid #ced4da" }} />
          ...
          {/* <Row className="mb-4">
            ...
            <Col xs={12} md={6}>
              <Form.Control type="text" placeholder="" className="d-flex justify-content-end" value={formData?.cap} name="cap" onChange={handleInputChange} style={{ border: "1px solid #ced4da" }} />
              {!isCapValid && formData.cap !== "" && <span style={{ color: "red", fontSize: "20px", marginTop: "4px" }}>{errorCap}</span>}
              {isCapValid && formData.cap !== "" && <span style={{ color: "green", fontSize: "20px", marginTop: "4px" }}>✅ </span>}
            </Col>
          </Row>
        ...
        <Modal.Footer className="d-flex justify-content-center mt-4">
          <Button onClick={() => handleModCitta()} className="justify-content-around" disabled={isButtonDisable}>
