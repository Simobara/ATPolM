  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <Row style={{ width: "100%" }}>
            <Col sm={12} xs={12} md={12} className=" mb-4">
              <Row>
                <Col xs={12} md={6}>
                  <h4>Nome Citta'</h4>
                </Col>
            ...
            <Col sm={12} xs={12} md={12} className=" mb-4 mt-1">
              <Row>
                <Col xs={12} md={6}>
                  <h4>CAP (numero)</h4>
                </Col>
        ...
        <Modal.Footer className="d-flex justify-content-center mt-2">
          <Button onClick={() => handleUpdate()} disabled={isButtonDisable} className="justify-content-around">
            {<SaveIcon />}Save and Close
          </Button>
        </Modal.Footer>
      </Modal>

      <div>{isModalAddProvActive && <AddProvModal propShow={isModalAddProvActive} propClose={handleAddProvModalClose} propListaProvCodAdded={provCod} />}</div>
    </>
  );
};
