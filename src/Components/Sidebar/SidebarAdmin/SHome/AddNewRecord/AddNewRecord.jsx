    ...
    return (
        <div className="form-wrapper">
            ...
            <form className="container mt-3 mb-3">
                <Row className="mb-3">
                    <Form.Group className=" col col-sm-6 text-label" controlId="formGridAddress1">
                ...
                <Row className="mb-3">
                    <Form.Group controlId="formGridCheckbox" className="col col-sm-6 text-label">
                        <Form.Label>Immagine</Form.Label>
                        <Form.Control className="form-control" type="file" name="immagine" value={formData.immagine} onChange={handleChange} />
                    </Form.Group>
                    <Form.Group controlId="formGridlabel " className="col col-sm-6 text-label">
                ...
                <Row className="mb-3">
                    <Form.Group controlId="formGridCheckbox text-label" className="d-flex w-100 col col-sm-6">
